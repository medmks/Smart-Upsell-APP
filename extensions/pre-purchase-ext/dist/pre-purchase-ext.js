...
${errorInfo.componentStack}`);
  ...
  function App() {
    ...
    const [recomendedproducts, setrecomendedproducts] = (0, import_react20.useState)([]);
    ...
    (0, import_react20.useEffect)(() => {
      function FetchTheRecommendedProduct(productId) {
        return __async(this, null, function* () {
          setLoading(true);
          try {
      ...
      function queryApi() {
        return __async(this, null, function* () {
          ...
          const { PrePurchaseEnabled } = yield FetchfromApisettings(token);
          ...
          yield FetchTheRecommendedProduct(ProductInCart);
        });
      }
      queryApi();
    }, []);
  ...
  function ProductRecomandation({ product, i18n, adding, handleAddToCart, showError, TitleExtension }) {
    ...
    const imageUrl = (_a = featuredImage.url) != null ? _a : "https://cdn.shopify.com/s/files/1/0533/2089/files/placeholder-images-image_medium.png?format=webp&v=1530129081";
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { spacing: "loose", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Divider2, {}),
